...
⚠️ 표현 금지: "확정 진단", "진단됩니다", "~입니다(진단명)", "확실히" — 이 표현들은 절대 사용하지 마세요.
...
{{
  ...
  "soap": {{
    ...
    "A": "Assessment. 감별진단 2~3개와 근거/반증. '확정 진단'·'~입니다(진단명)'·'진단됩니다' 절대 금지. 반드시 '~의심'·'~가능성'·'~추정' 표현 사용. 예: '위장염 의심(가능성 높음), 췌장염 가능성 배제 필요'",
