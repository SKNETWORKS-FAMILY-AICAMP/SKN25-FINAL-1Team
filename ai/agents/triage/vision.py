...
1) relevant: 반려동물의 '건강 증상'과 관련된 이미지면 true.
   - 증상에 포함: 피부·눈·귀·상처·자세·전신 상태뿐 아니라
     구토물(토사물)·대변·소변·분비물·콧물·침·혈흔 등 '몸에서 나온 것' 사진도 건강 증상으로 본다.
     (음식물처럼 보여도 토했거나 배설한 것이면 relevant=true)
   - 무관(false): 풍경·사람·캡처·텍스트, 그릇에 담긴 정상 사료/간식,
     반려동물이지만 건강과 무관한 일상 사진 등.
