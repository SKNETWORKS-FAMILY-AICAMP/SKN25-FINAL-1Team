...
function EditableSelect({
    ...
    return (
      <div className="flex items-center gap-1">
        <input
          ...
          className="w-full rounded border border-[#dfe6f1] px-2 py-1 text-sm outline-none focus:border-[#357b70]"
          autoFocus
        />
        <button
          type="button"
  ...
  return (
    <select
      ...
      className="w-full rounded border border-[#dfe6f1] bg-white px-2 py-1 text-sm outline-none focus:border-[#357b70]"
    >
    ...
    return (
      <div className="flex items-center gap-1">
        <input
          ...
          className="w-14 rounded border border-[#dfe6f1] px-2 py-1 text-sm outline-none focus:border-[#357b70]"
          autoFocus
        />
    ...
    <Panel>
      <div className="flex items-center justify-between border-b border-[#edf1f6] px-5 py-3">
        ...
        <button
          ...
          disabled={isReadOnly}
          className="h-9 rounded-lg bg-[#2f6f67] px-4 text-sm font-extrabold text-white transition hover:bg-[#255e57] disabled:cursor-not-allowed disabled:bg-[#c7d1df]"
        >
          진료 완료
        </button>
      </div>
      ...
      <div className="space-y-3 px-5 py-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            disabled={disabled}
            className="flex h-20 w-20 flex-col items-center justify-center rounded-lg border border-dashed border-[#cfd8e6] text-sm font-extrabold text-[#4d5874] transition hover:border-[#357b70] hover:text-[#2f6f67] disabled:cursor-not-allowed disabled:border-[#e5eaf2] disabled:bg-[#f9fafb] disabled:text-[#a8b0bf]"
          >
        ...
        <button
          ...
          className="flex h-16 w-full items-center justify-center gap-3 rounded-lg border border-dashed border-[#cfd8e6] text-sm font-extrabold text-[#59657a] transition hover:border-[#357b70] hover:text-[#2f6f67] disabled:cursor-not-allowed disabled:border-[#e5eaf2] disabled:bg-[#f9fafb] disabled:text-[#a8b0bf]"
        >
      ...
      <div className="space-y-3 px-5 py-4">
        <div ref={wrapperRef} className="relative">
          <input
            ...
            readOnly={isReadOnly}
            className="h-10 w-full rounded-lg border border-[#357b70] px-4 pr-10 text-sm font-bold outline-none ring-4 ring-[#eef5f4] read-only:border-[#dfe6f1] read-only:bg-[#f9fafb] read-only:text-[#8a94a6] read-only:ring-0"
          />
          <Search className="absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 text-[#357b70]" />
          {isOpen && (
              ...
              {results.map((drug) => (
                <li key={drug.drugid}>
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-sm hover:bg-[#eef5f4]"
                  >
                      ...
                      {isReadOnly ? (
                        ...
                        <div className="flex items-center justify-center">
                          <input
                            ...
                            className="h-3.5 w-3.5 cursor-pointer accent-[#2f6f67]"
                          />
                        </div>
                      )}
                    </td>
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            onClick={onGenerate}
            disabled={isReadOnly}
            className="flex h-10 items-center gap-2 rounded-lg border border-[#dfe6f1] bg-white px-5 text-sm font-extrabold text-[#4d5874] transition hover:border-[#357b70] hover:text-[#2f6f67] disabled:cursor-not-allowed disabled:bg-[#f9fafb] disabled:text-[#a8b0bf]"
          >
